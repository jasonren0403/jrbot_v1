        ...
        switch (command) {
            ...
            case "帮助": {
                mb.setCoolQ(CQ).setTarget(fromGroup).at(fromQQ).append(usage_main).newLine()
                        ...
                        .append("在线帮助网页地址：https://www.fantasyroom.cn/static/jrbot/help/index.html").sendGroupMsg();
                retval = 1;
                break;
            }
            case "select":
            ...
            case "dl_map":
            case "下谱": {
                if (fromGroup == 199498337 || fromGroup == 480628889) {   //测试环境
        ...
        switch (command.replace("#", "")) {
            ...
            case "/help": {
                mb.setCoolQ(CQ).setTarget(fromGroup).append("[群管理]帮助：").newLine()
                        ...
                        .append("详细帮助网址：https://www.fantasyroom.cn/static/jrbot/help/manage-group-with-bot/index.html").sendGroupMsg();
                break;
            }
            case "init":
            case "reinit":
